...
func (f *sharedInformerFactory) ForResource(resource schema.GroupVersionResource) (GenericInformer, error) {
	switch resource {
	// Group=elasticgpu.io, Version=v1alpha1
	case v1alpha1.SchemeGroupVersion.WithResource("elasticgpus"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Elasticgpu().V1alpha1().ElasticGPUs().Informer()}, nil
	case v1alpha1.SchemeGroupVersion.WithResource("elasticgpuclaims"):
